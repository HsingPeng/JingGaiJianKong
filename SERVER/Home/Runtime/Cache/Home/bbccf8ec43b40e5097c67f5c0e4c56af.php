...
<head>
	...
	<link rel="stylesheet" href="<?php echo (MEDIA_URL); ?>Home/css/manage_2.css" class="stylesheet">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-left">
					<li><a href="home.php?m=Home&c=Index&a=index">主页</a></li>
						<li class="dropdown">
...
<script type="text/javascript" src="<?php echo (MEDIA_URL); ?>Home/js/manage_2.js"></script>
