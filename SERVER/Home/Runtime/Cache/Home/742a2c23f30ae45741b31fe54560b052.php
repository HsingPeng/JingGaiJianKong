...
<head>
	...
	<link rel="stylesheet" href="<?php echo (MEDIA_URL); ?>Home/css/manage.css" class="stylesheet">
...
<script type="text/javascript" src="<?php echo (MEDIA_URL); ?>Home/js/manage.js"></script>
